...
uint32_t Measure::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("datapoints", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    std::vector<Datapoint> ::const_iterator _iter16;
    for (_iter16 = this->datapoints.begin(); _iter16 != this->datapoints.end(); ++_iter16)
    {
...
Measure::Measure(const Measure& other17) {
  metric = other17.metric;
  datapoints = other17.datapoints;
  __isset = other17.__isset;
}
Measure& Measure::operator=(const Measure& other18) {
  metric = other18.metric;
  datapoints = other18.datapoints;
...
RimpException::RimpException(const RimpException& other19) : TException() {
  description = other19.description;
  __isset = other19.__isset;
}
RimpException& RimpException::operator=(const RimpException& other20) {
...
VLanException::VLanException(const VLanException& other21) : TException() {
  description = other21.description;
  __isset = other21.__isset;
}
VLanException& VLanException::operator=(const VLanException& other22) {
...
StorageException::StorageException(const StorageException& other23) : TException() {
  description = other23.description;
  __isset = other23.__isset;
}
StorageException& StorageException::operator=(const StorageException& other24) {
...
LibvirtException::LibvirtException(const LibvirtException& other25) : TException() {
  code = other25.code;
...
LibvirtException& LibvirtException::operator=(const LibvirtException& other26) {
  code = other26.code;
