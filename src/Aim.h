...
class AimIf {
 public:
  ...
  virtual void getDomainState(std::string& _return, const std::string& domainName) = 0;
...
class Aim_getDomainState_result {
 public:
  ...
  Aim_getDomainState_result() : success() {
  }
...
class AimClient : virtual public AimIf {
 public:
  ...
  void recv_getDomainState(std::string& _return);
  void getDomainInfo(DomainInfo& _return, const std::string& domainName);
...
class AimMultiface : virtual public AimIf {
 ...
 public:
  ...
  void getDomainState(std::string& _return, const std::string& domainName) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->getDomainState(_return, domainName);
    }
    ifaces_[i]->getDomainState(_return, domainName);
    return;
  }
