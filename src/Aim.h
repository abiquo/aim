...
class Aim_getDatapoints_result {
 public:
  ...
  static const char* ascii_fingerprint; // = "6B035611289214E66C19F44D0860C3F5";
  static const uint8_t binary_fingerprint[16]; // = {0x6B,0x03,0x56,0x11,0x28,0x92,0x14,0xE6,0x6C,0x19,0xF4,0x4D,0x08,0x60,0xC3,0xF5};
